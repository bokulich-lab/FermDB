...
fermentedfood.new <- read_excel("FermDB_data.xlsx", .name_repair = function(x) gsub("\\s+", "_", x))
...
datatable(colnames = c("Continent","Region",'Subregion',"Country","Category","Product","Original_Name",
         ...
         options = list( columnDefs = list(
                      list(
                       ...
                       pageLength = nrow(fermentedfood.new),
                       filter = "top",
                       dom = 'Bfrtip',
...
```{=html}
<iframe src="standalone_fermpage/index.html" style='height: 100%; width: 100%;' frameBorder='0'></iframe>
```
...
* Marcel Houngbedji (Unviersité Nationale d’Agriculture, Benin)
